...
bool Callback(fcl::CollisionObjectd* object_A_ptr,
  ...
  // Three things:
  //   1. We repeatedly set `threshold` in each call to the callback because we
