...
class QueryObject {
  ...
  */
  ...
  @note Only contacts between geometry::Mesh with compliant-hydroelastic
   properties are supported, i.e, they must come from VTK tetrahedral meshes.
   Other kinds of geometry::Shape are ignored. Other geometry::Mesh with
   rigid-hydroelastic properties or non-hydroelastic properties are ignored.

  @note Unlike hydroelastics, the tetrahedral meshes do not need interior
   vertices. There is no need to refine the interior volume of the mesh.
   A tetrahedral mesh from a very coarse Constrained Delauany
   Tetrahedrization without interior vertices are ideal, e.g., a coarse mesh
   generated by TetGen without refinement.
